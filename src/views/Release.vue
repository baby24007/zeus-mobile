<template>
    <div>
        ...
        <mt-navbar v-model="selected">
            <mt-tab-item id="prod">生产环境</mt-tab-item>
            <mt-tab-item id="uat">UAT环境</mt-tab-item>
        </mt-navbar>
...
<script>
    ...
    export default {
        ...
        methods: {
            httpget: function () {
                const self = this;
                this.axios.get('/api/v1.0/element?page=1&env_name=uat&auth_user=zhangzhidao').then(function (response) {
